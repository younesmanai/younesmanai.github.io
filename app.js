...
function animateOpenNav() {
  ...
  tl.to(product1, {duration: 1, ease: "power3", x: 0, y: 150, scale: 1.8}, 0)
  tl.to(product1_h2, {duration: 1, opacity: 1, y: 20}, 0)
  tl.to(product2, {duration: 1, ease: "power3", x: -120, y: -150, scale: 0.4}, 0)
  tl.to(product3, {duration: 1, ease: "power3", x: -120, y: -250, scale: 0.4}, 0)
  tl.to(product4, {duration: 1, ease: "power3", x: -120, y: -350, scale: 0.4}, 0)
