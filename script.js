...
btn.addEventListener("click", () => {
  ...
  gsap.to(b1, {y: -320, x: -20, duration: 1, scale: 0.7, ease: "power1"});
  gsap.to(b2, {y: -220, x: -305, duration: 1, scale: 0.7, ease: "power1"});

  gsap.to(b3, {keyframes: [
  							{duration: 0.5, x: 10},
    						{duration: 0.5, y: -140},
    						{duration: 0.5, scale: 3.2, height: 160}
  							]});
...
btnBack.addEventListener("click", () => {
  ...
  gsap.to(b2, {x: 0, y: 0, duration: 1, ease: "power1"});

  gsap.to(b3, {keyframes: [
  							{duration: 0.8, scale: 0.7},
  							{duration: 0.8, y: 0},
  							{duration: 0.8, x: 20}
  							]});
