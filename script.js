...
btn.addEventListener("click", () => {
  ...
  gsap.to(b1, {y: -210, x: -40, duration: 1, scale: 0.4, ease: "power1"});
  gsap.to(b2, {y: -150, x: -365, duration: 1, scale: 0.4, ease: "power1"});

  gsap.to(b3, {keyframes: [
  							{duration: 0.5, x: -270},
    						{duration: 0.5, y: -60},
    						{duration: 0.5, scale: 3, height: 130}
  							]});
...
btnBack.addEventListener("click", () => {
  ...
  gsap.to(b1, {x: 0, y: 0, scale: 1, duration: 1, ease: "power1"});
  gsap.to(b2, {x: 0, y: 0, scale: 1, y: 0, duration: 1, ease: "power1"});

  gsap.to(b3, {keyframes: [
  							{duration: 0.8, scale: 1, height: 90},
  							{duration: 0.8, y: 0},
  							{duration: 0.8, x: 0}
  							]});
...
let fermer = document.querySelector(".validate");



oreos.addEventListener("click", () => {
   gsap.to(".principal-title", { duration: 0.3, color: "#af7603" });
   gsap.to(oreosH2, { duration: 0.5, opacity: 1, x: 45, y: -10, scale: 1.3 });

   gsap.to(oreos, { duration: 0.5, y: 200, scale: 4});
   gsap.to(".img-cookies", { duration: 0.5, opacity: 0, x: -100});
   gsap.to(".img-coffees", { duration: 0.5, opacity: 0, x: 100,});

   gsap.to(".oreos-descriptions", {duration: 0.5,scale: 0.3, x: -10, y: -50});
   


   gsap.to(fermer, { duration: 0.5, opacity: 1, scale: 1});
...
fermer.addEventListener("click", () => {
  gsap.to(".principal-title", { duration: 0.3, color: "#000" });
   ...
   gsap.to(oreos, { duration: 0.5, y: 0, scale: 1});
   ...
   gsap.to(fermer, { duration: 0.5, opacity: 0, scale: 0});
