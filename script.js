...
btn.addEventListener("click", () => {
  ...
  gsap.to(b1, {y: -280, x: 10, duration: 1, ease: "power1"});
  gsap.to(b2, {x: -130, y: -170, duration: 1, ease: "power1"});
...
oreos.addEventListener("click", () => {
   ...
   gsap.to(oreosH2, { duration: 0.5, opacity: 1, x: 45, color: "#af7603", y: -10, scale: 1.3 });
