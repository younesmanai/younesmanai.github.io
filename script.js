...
oreos.addEventListener("click", () => {
   ...
   gsap.to(oreos, { duration: 0.5, x: 20, y: 280, scale: 4});
   ...
   gsap.to(".oreos-descriptions", {duration: 0.5, scale: 0.3, x: -80, y: -50});
   
   gsap.to(validate, { duration: 0.5, opacity: 1, x: -40, y: 550, scale: 1});
...
validate.addEventListener("click", () => {
  gsap.to(".principal-title", { duration: 0.3, color: "#000" });
   ...
   gsap.to(oreos, { duration: 0.5, y: 0, x: 0, scale: 1});
...
validate.addEventListener("click", () => {
  // gsap.to(".principal-title", { duration: 0.3, color: "#000" });
   ...
   // gsap.to(oreos, { duration: 0.5, x: 100, opacity: 1});
   gsap.to(".img-coffees", { duration: 0.5, opacity: 1, x: 0});
   gsap.to(".cookies-descriptions", { duration: 0.5, scale: 0, x: 80, y: 50});
