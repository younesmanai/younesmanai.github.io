...
guerlain.addEventListener("click", () => {
  ...
  description.addEventListener("click", () => {
      ...
      gsap.to(descriptionContent, {duration: 1, opacity: 1, width: 270, height: 400, ease: "power2"});
      ...
      gsap.to(collectionTitle, {duration: 1, color: "#fff", scale: 0.7,  ease: "power2"});
});
...
close.addEventListener("click", () => {
      ...
      // gsap.to(collectionTitle, {duration: 1, color: "#fff", scale: 0,  ease: "power2"});
