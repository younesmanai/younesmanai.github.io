...
guerlain.addEventListener("click", () => {
  ...
  gsap.to(description, {duration: 1, color: "#f3a0f7",  ease: "power2"});
...
hedonist.addEventListener("click", () => {
  ...
  gsap.to(guerlain,  {duration: 1, x: 50, y: 80, width: 260, ease: "power2"});
  ...
  gsap.to(description, {duration: 1, color: "#d8a3ff",  ease: "power2"});

  description.addEventListener("click", () => {
      gsap.to(descriptionContentB, {duration: 1, opacity: 1, width: 150, height: 200, ease: "power2"});
...
close.addEventListener("click", () => {
      gsap.to(descriptionContent, { opacity: 0});
});
